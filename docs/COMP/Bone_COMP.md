...
#### X Angle Range `xrange`

Specifies the maximum and minimum rotation angles.

- **beginxrange** `beginxrange`
- **endxrange** `endxrange`

#### X Damping Angle `xdamp`
