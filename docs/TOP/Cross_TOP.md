...
Determines the amount each input is added to the output. When Cross = 0, Input1 is output; when Cross = 1, Input2 is output.
...
Extra Information for the Cross TOP can be accessed via an Info CHOP.
