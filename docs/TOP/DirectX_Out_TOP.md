...
Enable or disable DirectX output.

#### Queue Size `queuesize`

Number of DirectX textures created. These textures are updated in a cycle, 1 per frame. Use an Info DAT to inspect the list of textures.
...
Extra Information for the DirectX Out TOP can be accessed via an Info CHOP.
