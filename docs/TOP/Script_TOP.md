...
See numPyArray() in TOP Class., Script DAT.
...
Allows TOP to be updated by external script without having to lock the TOP
...
Extra Information for the Script TOP can be accessed via an Info CHOP.
