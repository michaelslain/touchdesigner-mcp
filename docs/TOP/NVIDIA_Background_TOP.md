...
The background engine only supports videos with a minimum width of 512 pixels and minimum height of 288 pixels.
...
Choose which mode to run the AI model in.
...
Extra Information for the Nvidia Background TOP can be accessed via an Info CHOP.
