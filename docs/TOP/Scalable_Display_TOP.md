...
See also Projection Mapping, Vioso, kantanMapper, camSchnappr, projectorBlend
...
Specify the location of the Scalable Displays Calibration Data file.
...
Extra Information for the Scalable Display TOP can be accessed via an Info CHOP.
