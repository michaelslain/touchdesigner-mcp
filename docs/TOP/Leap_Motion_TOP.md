...
- **Version 2 Tracking** `default` - Legacy tracking that includes gesture and tool tracking. Download Leap Motion Orion Beta 3.2.1
- **Orion (v4) / Gemini (v5)** `on` - Orion offers more stable and reliable hand and finger tracking compared to v2. Download Orion 4.1.0. Gemini offers even better performance with improved stability and much faster hand recognition to start tracking. Download Gemini 5.6.1.
