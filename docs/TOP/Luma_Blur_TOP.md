...
The greyscale can be any channel of the second input, or composites like luminance and RGB average.
...
The pixel luminance value used for the Black Filter Size parameter below.

#### White Value `whitevalue`

The pixel luminance value used for the White Filter Size parameter below.

#### Black Filter Width `blackwidth`

The amount of blur where the second input is black.

#### White Filter Width `whitewidth`

The amount of blur where the second input is white.
