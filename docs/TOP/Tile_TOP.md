...
Positions the left edge of the image.

#### Crop Left Unit `cropleftunit`

#### Crop Right `cropright`

Positions the right edge of the image.

#### Crop Right Unit `croprightunit`

#### Crop Bottom `cropbottom`

Positions the bottom edge of the image.

#### Crop Bottom Unit `cropbottomunit`

#### Crop Top `croptop`

Positions the top edge of the image.
...
Similar to performing a flop on the image (See Flip TOP) without changing the resolution. It swaps the position of the bottom-right corner with the upper-left corner, while maintaining the original resolution and aspect ratio.
...
Reflects the tiles in X. NOTE: Must have Tile Y set to 2.

#### Reflect Y `reflecty`

Reflects the tiles in Y. NOTE: Must have Tile X set to 2.

#### Overlap U `overlapu`

Blends the edges together on the right and left edges of the tiles.

#### Overlap U Unit `overlapuunit`

#### Overlap V `overlapv`

Blends the edges together on the bottom and top edges of the tiles.
...
Extra Information for the Tile TOP can be accessed via an Info CHOP.
