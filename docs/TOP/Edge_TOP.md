...
This menu determines how the edges are pulled from the image.
...
Applies a black level adjustment to the input image before finding the edges.

#### Strength `strength`

Higher gain values will make more edge details appear.
...
This menu determines how the alpha channel is output from the Edge TOP.
...
Choose how the image should be combined with the input.
...
Extra Information for the Edge TOP can be accessed via an Info CHOP.
