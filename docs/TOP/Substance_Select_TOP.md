...
Reference a specific Substance TOP from which to select a texture.

#### Output Channel `output`

Choose which texture is being grabbed from the Substance TOP.
...
Extra Information for the Substance Select TOP can be accessed via an Info CHOP.
