...
Specify which input and channel is used as the red channel in the output image.

#### Output Red Channel `outputredchan`

The channel to use from the selected input to use as the red channel in the output image.

#### Ouput Green `outputgreen`

Specify which input and channel is used as the green channel in the output image.

#### Ouput Green Channel `outputgreenchan`

The channel to use from the selected input to use as the green channel in the output image.

#### Ouput Blue `outputblue`

Specify which input and channel is used as the blue channel in the output image.

#### Ouput Blue Channel `outputbluechan`

The channel to use from the selected input to use as the blue channel in the output image.

#### Output Alpha `outputalpha`

Specify which input and channel is used as the alpha channel in the output image.

#### Output Alpha Channel `outputalphachan`

The channel to use from the selected input to use as the alpha channel in the output image.
...
Extra Information for the Reorder TOP can be accessed via an Info CHOP.
