...
The maximum red value that is added to the key. 0 = min, 1 = max.

#### Red Soft Low `rsoftlow`

The rate of falloff at the Red Min setting.

#### Red Soft High `rsofthigh`

The rate of falloff at the Red Max setting.

### Green Page

#### Green Min `greenmin`

The minimum green value that is added to the key. 0 = min, 1 = max.

#### Green Max `greenmax`

The maximum green value that is added to the key. 0 = min, 1 = max.

#### Green Soft Low `gsoftlow`

The rate of falloff at the Green Min setting.

#### Green Soft High `gsofthigh`

The rate of falloff at the Green Max setting.

### Blue Page

#### Blue Min `bluemin`

The minimum blue value that is added to the key. 0 = min, 1 = max.

#### Blue Max `bluemax`

The maximum blue value that is added to the key. 0 = min, 1 = max.

#### Blue Soft Low `bsoftlow`

The rate of falloff at the Blue Min setting.

#### Blue Soft High `bsofthigh`

The rate of falloff at the Blue Max setting.
...
Determines the output of the RGB channels from the RGB Key TOP.
...
Determines the output of the Alpha channel from the RGB Key TOP.
...
Extra Information for the RGB Key TOP can be accessed via an Info CHOP.
