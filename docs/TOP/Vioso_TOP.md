...
The Vioso TOP lets you load calibration data retrieved from running the VIOSO 6 software. Please refer to the Vioso entry for a complete guide on TouchDesigners integration of the VIOSO 6.

Also have a look at the MPCDI TOP for loading mpcdi files exported from VIOSO.
...
Specify the location of the .vwf file exported from Vioso 6.

#### Projector Index `projectorindex`

Specify the index of the output projector.
...
Extra Information for the Vioso TOP can be accessed via an Info CHOP.
