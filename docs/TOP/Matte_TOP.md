...
Changes which image is composited over the other. This has the same effect as physically swapping input1 and input2. Also the same as inverting the alpha channel to input3.

#### Matte Channel `mattechannel`

Select which channel from input3 is used to create the matte.
...
Extra Information for the Matte TOP can be accessed via an Info CHOP.
