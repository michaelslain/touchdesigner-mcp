...
Scales the blur in three different axes. Each component of the Filter Scale is multiplied by the Filter Size to define the total amount of blur for each axis in pixels.
...
Rotates the blur filter. More noticeable when performing a horizontal blur.
