...
Adjust the amount of color left in the image. 0 is full color, 1 is full greyscale.

#### RGB `rgb`

This menu selects how the monochrome conversion is calculated for the RGB channels.
...
This menu selects how the monochrome conversion is calculated for the alpha channel.
...
Extra Information for the Monochrome TOP can be accessed via an Info CHOP.
