...
The path of the TOP being referenced. Drag & drop any TOP here, or manually enter the path to the TOP.
...
Extra Information for the Select TOP can be accessed via an Info CHOP.
