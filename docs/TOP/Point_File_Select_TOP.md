...
A link to the Point File In TOP that contains the original point file data.
...
Extra Information for the Point File Select TOP can be accessed via an Info CHOP.
