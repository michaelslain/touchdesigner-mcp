...
Specify the units used to position the pivot point.
...
Rotates a copy of the image around the pivot point specified above.

#### Extend `extend`

This parameter determines what happens at the edge of the image.
...
Extra Information for the Mirror TOP can be accessed via an Info CHOP.
